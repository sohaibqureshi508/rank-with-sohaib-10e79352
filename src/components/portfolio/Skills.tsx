export function Skills() {
  const skillCategories = [
    ...
    {
      title: "Off-Page SEO",
      skills: ["PBN Link Building", "Directory Submissions", "Profile Creation", "Image Submissions", "Bookmarking"]
    },
    {
      title: "Tools & Research",
      skills: ["SEMrush", "Keyword Research", "Competitor Analysis", "Search Intent Analysis", "Search Console (Basic)"]
    }
  ];
    ...
    <section id="skills" className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center mb-16">
          <h2 className="text-base font-semibold leading-7 text-blue-600 uppercase tracking-wide">SEO Stack</h2>
